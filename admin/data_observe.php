                            ...
                            if(isset($_GET['edit'])){
                                ...
                                <div class='card'>
                                    ...
                                    <div class='card-body card-block'>
                                        ...
                                        <a type='reset' class='btn btn-danger btn-sm' href='?page=data_observe'>
                                ...
                                if(isset($_POST['update'])){
                                    ...
                                    echo "<script>window.alert('Data Berhasil Diubah');window.location=('?page=data_observe')</script>";
                                }
                            ...
                            if(isset($_POST['simpan'])){
                                    mysqli_query($con,"INSERT INTO tbobservasi(idobservasi,idsiswa,foto,ctt_observe)
                                        VALUES ('$_POST[idobservasi]',
                                                ...
                                                '$_POST[foto]',
                                                '$_POST[ctt_observe]')");
                                        echo "<script>window.alert('Data Berhasil Disimpan');window.location=('?page=data_observe')</script>";
                                }
                            }elseif(isset($_GET['hapus'])) {
                                mysqli_query($con,"DELETE FROM tbobservasi WHERE idobservasi='$_GET[hapus]'")or die(mysqli_error());
                                echo "<script>alert('Berhasil Dihapus'); window.location = '?page=data_observe'</script>";
                            }else{
                        ?>
                                       ...
                                       <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="table-data-feature">
                                                    <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="?page=data_observe&edit=<?php echo $data['idobservasi']; ?>">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="?page=data_observe&hapus=<?php echo $data['idobservasi']; ?>">

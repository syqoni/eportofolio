...
<html lang="en"> 
    ...
    <?php
        if(isset($_GET['idpilar'],$_GET['nisn'],$_GET['idsem'])){
            ...
            $sql = "SELECT * FROM tbnilaikd 
                    ...
                    WHERE tbsiswa.idsiswa='$idsiswa' AND tbpilar.kdpilar='$kdpilar' AND tbobservasi.kdpilar='$kdpilar' AND tbsemester.idsem='$idsem'";
    ...
    <div style="width:100%;padding: 10px;text-align:left;border-width: 1;">
        ...
        if ($txpilar=='AKHLAK DAN LEADERSHIP'){
            echo"<p style='font-size:8px;'>(** 1 = Tidak Terlihat, 2 = Jarang Terlihat, 3 = Kadang-Kadang Terlihat, 4 = Sering Terlihat, 5 = Selalu Terlihat)</p>";
        }else{
            echo"<p style='font-size:8px;'>(** 1 = Perlu Perbaikan, 2 = Berkembang, 3 = Mandiri)</p>";
        }
        ?>
    </div>

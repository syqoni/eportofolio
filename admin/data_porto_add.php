                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-2">
                                                    <label for="idkelas" class="form-control-label">Pilar</label>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                            <tr>
                                                                ...
                                                                <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="?page=data_porto_add&nisn=<?php echo $row['idsiswa'];?>&kdpilar=<?php echo $kdpilar;?>&idkelas=<?php echo $idkelas;?>">
